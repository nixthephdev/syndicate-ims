...
class OtpCodeTest extends TestCase
{
    ...
    {
        $user = User::factory()->create();
        [$otp, $code] = OtpCode::issue($user, OtpCode::PURPOSE_LOGIN);
    ...
    {
        $user = User::factory()->create();
        [$otp] = OtpCode::issue($user, OtpCode::PURPOSE_LOGIN);
    ...
    {
        $user = User::factory()->create();
        [$first, $firstCode] = OtpCode::issue($user, OtpCode::PURPOSE_LOGIN);
        [$second, $secondCode] = OtpCode::issue($user, OtpCode::PURPOSE_LOGIN);
    ...
    public function test_a_login_code_does_not_verify_for_a_checkout_lookup(): void
    {
        $user = User::factory()->create();
        [, $code] = OtpCode::issue($user, OtpCode::PURPOSE_LOGIN);
